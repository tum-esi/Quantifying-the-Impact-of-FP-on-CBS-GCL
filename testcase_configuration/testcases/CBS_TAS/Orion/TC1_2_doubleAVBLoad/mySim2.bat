...
for /l %%i in (1,1,%NUM_SIMULATIONS%) do (
    ...
    set OUTPUT_DIR=D:/testcase_results/TAS_CBS/orion/idleslope_fixed/AVBX_A/simtime_1s_100/frozen/results/run%%i
	mkdir %OUTPUT_DIR%
...
for /l %%j in (1,1,%NUM_SIMULATIONS%) do (
	cd D:/testcase_results/TAS_CBS/orion/idleslope_fixed/AVBX_A/simtime_1s_100/frozen/results/run%%j
