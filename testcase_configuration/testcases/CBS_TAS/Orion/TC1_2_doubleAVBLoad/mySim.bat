...
for /l %%i in (1,1,%NUM_SIMULATIONS%) do (
    ...
    set OUTPUT_DIR=C:/Users/comet/Documents/MT_GitRepo/inet-testsetup/Programming/IVN2/testcases/CBS_TAS/Orion/TC1_2_doubleAVBLoad/results/run%%i
	mkdir %OUTPUT_DIR%
    
    cd C:/Users/comet/Documents/MT_GitRepo/inet-testsetup/Programming/IVN2/testcases/CBS_TAS/Orion/TC1_2_doubleAVBLoad
...
for /l %%j in (1,1,%NUM_SIMULATIONS%) do (
	cd C:/Users/comet/Documents/MT_GitRepo/inet-testsetup/Programming/IVN2/testcases/CBS_TAS/Orion/TC1_2_doubleAVBLoad/results/run%%j
