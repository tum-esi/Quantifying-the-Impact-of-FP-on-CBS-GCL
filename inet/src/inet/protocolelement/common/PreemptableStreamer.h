...
class INET_API PreemptableStreamer : public ClockUserModuleMixin<PacketProcessorBase>, public virtual IPacketFlow, public cListener
{
  protected:
    ...
    // added by ph
    bool isTransmissionAllowed_ = true;
    bool isGuardbandActive = false;
