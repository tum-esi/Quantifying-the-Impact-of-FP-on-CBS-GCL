...
class INET_API CreditBasedGate : public PacketGateBase, public cListener
{
  ...
  protected:
    ...
    double AVBClosingDuration = 0;
    double hyperperiod = NaN;

//    // added by ph
//    std::string creditMode = "S";

    enum CreditMode // added by ph
    {
        standard = 2,
        frozen = 1,
        returnToZero = 0
    ...
    CreditMode creditMode; // added by ph
